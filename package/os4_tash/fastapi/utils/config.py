"""Application configuration shared by reusable FastAPI helpers."""
...
class BasicSettings(BaseSettings):
    """Default configuration used by the reusable FastAPI scaffolding."""
    ...
    LOG_RESOURCE: str = Field(
        default="APP",
        description="Resource identifier prefixed to each log entry.",
        examples=["argocd", "tyk"],
    )
